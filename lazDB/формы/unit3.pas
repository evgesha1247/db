...
procedure TFormBook.Button1Click(Sender: TObject);
  begin
    ...
    SQLQueryAdd.Close;
    SQLQueryAdd.Clear;
    SQLQueryAdd.SQL.Text := 'insert into products(id,products_name, idWriter , idGenre , remark) values(:id, :products_name,  :idWriter , :idGenre , :remark); ';
    SQLQueryAdd.ParamByName('products_name').AsString := Edit1.Text;
...
begin
    ...
    SQLQueryZapros.SQL.Text := 'update products set products_name = :products_name, idWriter = :idWriter, ';
    ...
    SQLQueryZapros.ParamByName('products_name').AsString :=  Edit1.Text;
...
procedure TFormBook.DBGrid1CellClick(Column: TColumn);
  begin
     ...
     Edit1.text := SQLQuery.FieldByName('products_name').AsString;
