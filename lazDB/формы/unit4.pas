...
type
  ...
  TForm6 = class(TForm)
    ...
    Label7: TLabel;    Label8: TLabel;Label10: TLabel;
    Label9: TLabel;
    MemoRemark: TMemo;
...
procedure TForm6.Button1Click(Sender: TObject);
  begin
   ...
   SQLQueryAdd.Close;
   SQLQueryAdd.Clear;
   SQLQueryAdd.SQL.Text := 'insert into writers(id, writers_name, patronymic , surname ,yearOfBirth , yearOfDeath , country , placeOfBirth , remark) ';
   SQLQueryAdd.SQL.Add('values(:id, :writers_name,  :patronymic , :surname , :yearOfBirth , :yearOfDeath , :country , :placeOfBirth , :remark); ');
   SQLQueryAdd.ParamByName('writers_name').AsString := EditName.Text;
   ...
   SQLQueryAdd.ParamByName('remark').AsString :=  MemoRemark.Lines.Text;
   SQLQueryAdd.ExecSQL;
   ClearAndActivety;
  end;
...
begin
    ...
    SQLQueryZapros.SQL.Text := 'update writers set writers_name = :writers_name, patronymic = :patronymic, ';
    ...
    SQLQueryZapros.ParamByName('writers_name').AsString :=  EditName.Text;
    ...
    SQLQueryZapros.ParamByName('remark').AsString :=   MemoRemark.Lines.text;
...
procedure TForm6.DBGrid1CellClick(Column: TColumn);
  begin
    ...
    EditName.Text        := SQLQuery.FieldByName('writers_name').AsString;
    ...
    MemoRemark.Lines.text:= SQLQuery.FieldByName('remark').AsString;
  end;
...
procedure TForm6.ButtonNextClick(Sender: TObject);
begin
